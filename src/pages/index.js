...
import DemoPage from "../components/DemoGallery/DemoPage";
        ...
        <header className={clsx('container', styles.heroBanner)}>
            <div className="row padding-horiz--md">
                <div className="col col--7">
                    <div className={clsx(styles.relative, 'row')}>
                        <div className="col">
                            <h1 className={styles.tagline}>
                                Lumina-T2X is a unified<br /> framework for Text to Any Modality
                                {/* Crawlee is a web<br /> scraping and browser<br /> automation library */}
                            </h1>
                            <h1 className={styles.tagline}>
                                Lumina-T2X is a <span>unified<br /> framework</span> for<span> Text to Any Modality</span>
                    ...
                    <div className="row">
                        <div className="col">
                            <h2>It helps you build a Generation Model with any modailty. Fast.</h2>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col">
                            <div className={styles.heroButtons}>
                                ...
                                <iframe src="https://ghbtns.com/github-btn.html?user=Alpha-VLLM&repo=Lumina-T2X&type=star&count=true&size=large" frameBorder="0" scrolling="0" width="170" height="30" title="GitHub"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
                <div className={clsx(styles.relative, 'col', 'col--5')}>
                    <div className={styles.logoBlur}>
                        <img src={require('../../static/img/lumina-logo-blur.png').default} className={clsx(styles.hideSmall)} />
                    </div>
            ...
            <div className="row">
                ...
                <div className="col col--6">
                    <div className="video-container">
                        <img src={require('../../static/img/framework/framework.jpg').default} className="framework" style={{ width: '300%', height: 'auto' }} />
                    </div>
                </div>
            </div>
        </section>
...
function ActorExample() {
    return (
        <section className={clsx(styles.try, 'container')}>
            <div className="col">
                <h2>Try Lumina-T2X 👾</h2>
                <Admonition type="caution" title="before you start">
                    Lumina-T2X requires <a href="https://nodejs.org/en/" target="_blank" rel="noreferrer"><b>Python 3.10 or higher</b></a>.
                </Admonition>
                <p>
